...
import { defaultEmulatorSettings, convertSettingsToArray } from './settings/emulatorSettings';

export var gbRunInterval = null;				//GameBoyCore Timer
export var settings = convertSettingsToArray(defaultEmulatorSettings);
